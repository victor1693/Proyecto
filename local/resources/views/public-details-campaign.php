                    ...
                    <div class="col-12 col-lg-10 col-xl-8">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-4">
                                        <img class="img-fluid rounded mb-2" src="https://i.scdn.co/image/ab67616d0000b27323152d9337d6c57b116ed13a"/>
                                    ...
                                    <div class="col-8">
                                        ...
                                        <div style="margin-left: -5px">
                                            <span class="badge bg-primary-soft fw-bold ms-2">
                                                Salsa
                                            </span>
                                            <span class="badge bg-primary-soft fw-bold ms-2">
                                                Merengue
                        ...
                        <div class="mb-5 row">
                            <div class="col-6" style="text-align: left;">
                                <a class="btn btn-primary" href="public-schedule-campaign.php" style="width: 120px;">
                                    Go Back
                                </a>
                            </div>
                            <div class="col-6" style="text-align: right;">
                                <a class="btn btn-primary" href="public-cuestomer-info.php" style="width: 120px;">
                                    Continue
                                </a>
                            </div>
                        </div>
